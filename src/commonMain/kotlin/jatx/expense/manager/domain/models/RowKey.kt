...
data class RowKey(
    ...
    fun withIntKey(allCardNames: ArrayList<String>, allCategories: ArrayList<ArrayList<String>>): RowKey {
        val key = if (cardName == overallCardName && category == totalCategory) {
            0
        } else {
...
fun makeTotalMinus2RowKey(cardNameKey: Int) =
